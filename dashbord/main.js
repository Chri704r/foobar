...
function showQueue(data) {
  ...
  data.queue.forEach((order) => {
    const clone = document
      .querySelector("template.customer-dashboard")
...
function setDate() {
  ...
  if (minutes < 10 && seconds < 10) {
    document.querySelector(
      ".digital-clock"
    ).innerHTML = `${hours}:0${minutes}:0${seconds}`;
  } else if (minutes < 10) {
    document.querySelector(
      ".digital-clock"
    ).innerHTML = `${hours}:0${minutes}:${seconds}`;
  } else if (seconds < 10) {
    document.querySelector(
      ".digital-clock"
    ).innerHTML = `${hours}:${minutes}:0${seconds}`;
  } else {
    document.querySelector(
      ".digital-clock"
...
function loginFunction() {
  ...
  document
    .querySelector("#login-section input[type=text]")
